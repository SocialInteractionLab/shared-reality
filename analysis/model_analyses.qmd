...
for i, stance in enumerate(['opposing', 'shared']):
    ...
    ax.bar(x + offset, rates, width, color=COLORS[stance], label=f'{stance.capitalize()} stance',
...
for ax, (stance, title) in zip(axes, [('shared', 'Shared Stance'), ('opposing', 'Opposing Stance')]):
    for cat in ['matched', 'same_domain', 'different_domain']:
