...
# Run k=5 model (Bayesian, β=0) with paper's parameters
...
m_bayes = CommonalityModel(k=5, beta=0.0, loadings=real_loadings,
    sigma_obs=0.3, sigma_prior=2.0, match_threshold=1.5, epsilon=0.2)
...
m_proj = CommonalityModel(k=0, beta=1.0,
...
for seed in range(100):
    ...
    m = CommonalityModel(k=5, beta=0.0, loadings=real_loadings[perm, :],
        sigma_obs=0.3, sigma_prior=2.0, match_threshold=1.5, epsilon=0.2)
