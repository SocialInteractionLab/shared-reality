...
# Compute mean commonality rate per domain × category × stance
rates = (gen_df.groupby(['domain_cap', 'category', 'stance'])['predictShared']
         .mean().reset_index())

# Pivot to get shared and opposing side by side, then compute transfer effect
...
pivot['question_type'] = pivot['category'].map({'sameD': 'Same domain', 'diffD': 'Different domain'})
