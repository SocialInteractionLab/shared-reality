...
To characterize the stimulus set, an independent sample (N = 15–27 per dimension) rated each question on several dimensions: how personally revealing, how divisive or controversial, how deep, how much one would learn from the answer, and expected population agreement. Ratings were made on 0–100 scales.
...
norm_cols = ['norm_personal', 'norm_divisive', 'norm_deep', 'norm_learn', 'norm_same']
...
domain_norms.columns = ['Personal', 'Divisive', 'Deep', 'Learn', 'Exp. Agreement']
