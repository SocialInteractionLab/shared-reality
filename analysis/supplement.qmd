...
# Re-import (Python state can be lost between chunks with knitr engine)
import polars as pl
from polars import col, lit
from pathlib import Path
...
# Re-import after R chunks (knitr engine loses Python state)
import numpy as np
import pandas as pd
import matplotlib.pyplot as plt
import seaborn as sns
...
# Load processed data
inf_df = pd.read_csv('/tmp/df_pd_processed.csv')
inf_df = inf_df[inf_df['question'] != inf_df['matchedIdx']]
...
for qt in ['same_domain', 'different_domain']:
    for stance in ['shared', 'opposing']:
        cell = nochat_data[(nochat_data['question_type'] == qt) & (nochat_data['stance'] == stance)]
...
nochat_eval = nochat_data[['pid', 'question', 'question_type', 'stance',
